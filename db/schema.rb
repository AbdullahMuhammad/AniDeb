...
ActiveRecord::Schema.define(version: 2023_07_13_151826) do
  ...
  create_table "fights", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
  ...
  create_table "mangas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "mal_id"
    t.text "description"
    t.datetime "created_at", precision: 6, null: false
